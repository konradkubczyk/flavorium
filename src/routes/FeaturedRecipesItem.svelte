<script lang="ts">
	...
	export let recommendedRecipe: any;
</script>

<a
	id="featured-recipe-item"
...
>
	...
	<p class="text-sky-900 mt-3 overflow-hidden">
		{recommendedRecipe['description'].length > 250
			? recommendedRecipe['description'].substring(0, 250).trim() + '...'
